...
function StatusTracker(props) {
    ...
    return (
        <div className="container flex justify-center items-center align-middle text-center">
            <svg className="relative h-full w-full transform max-w-xl md:max-w-2xl" viewBox="-30 0 750 90" fill="none">
