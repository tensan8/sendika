            ...
            <div className={"row container h-full mx-auto px-6 flex flex-col-reverse lg:flex-row justify-between items-center relative"}>
                ...
                <div className={"left column w-full mb-16 md:mb-0 text-center lg:text-left"}>
                    ...
                    <p>
                        ...
                        <br/><br/>Participating in their first competition in making innovation by using Data, Alesandro and Bryan have decided to make an AI model by utilizing the SMILES dataset. 
                        This project was made as one of the deliverables that this team will use to show the innovation in a website integrated with Artificial Intelligence.
                        <br/><br/>Sendika will help researchers to predict the pIC50 value of a compound. It might help researchers to predict potential inhibitors of HIV-1 integrase.
                    </p>
                </div>
